describe("Deck", function() {
  ...
  describe("AJAX functions", function() {
    ...
    it("makes a real AJAX request", function() {
      var ajax_deck = new Deck('/decks/1/cards');
      waitsFor(function() {
        return ajax_deck.loadCards();
      });

      runs (function() {
        expect(ajax_deck.cards[0].native_word).toEqual("laptop");
      });
    });
  });
});